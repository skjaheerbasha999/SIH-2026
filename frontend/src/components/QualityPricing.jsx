    ...
    <section id="quality" className="py-20 lg:py-28 bg-white relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          {/* Card A */}
          <div className="bg-white rounded-2xl p-6 border border-emerald-200 shadow-xs hover:shadow-lg transition-all flex flex-col justify-between space-y-4">
          ...
          {/* Card B */}
          <div className="bg-white rounded-2xl p-6 border border-amber-200 shadow-xs hover:shadow-lg transition-all flex flex-col justify-between space-y-4">
            <div className="flex items-center justify-between">
              <div>
          ...
          {/* Card C */}
          <div className="bg-white rounded-2xl p-6 border border-red-200 shadow-xs hover:shadow-lg transition-all flex flex-col justify-between space-y-4">
            <div className="flex items-center justify-between">
              <div>
