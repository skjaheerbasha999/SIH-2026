...
export const Hero = () => {
  ...
  return (
    <section id="hero" className="relative pt-12 pb-20 md:pt-16 md:pb-28 overflow-hidden bg-gradient-to-b from-[#f4fbf7] via-white to-white bg-saas-grid min-h-[90vh] flex flex-col justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center mt-6 lg:mt-0">
            <RevealOnScroll animation="scale" delay={300} className="w-full flex justify-center">
              <AgriculturalVisual />
            </RevealOnScroll>
          </div>
